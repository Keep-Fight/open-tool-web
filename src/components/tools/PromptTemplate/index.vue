  ...
  <div class="bg-card-window-body grid grid-cols-1 lg:grid-cols-20 gap-6 items-start mx-auto">
    ...
    <aside class="lg:col-span-3  p-5">
      ...
      <div class="flex gap-2 mb-4">
        <button class="flex-1 bg-slate-50 hover:bg-slate-100 dark:bg-[#1c1c1f] dark:hover:bg-[#252529] text-slate-600 dark:text-[#a1a1aa] border border-slate-200 dark:border-[#3f3f46] py-1.5 rounded-md text-xs flex justify-center items-center gap-1.5 transition-colors cursor-pointer">
          <!-- 导入图标 (Arrow Down) -->
